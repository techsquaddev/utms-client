...
const TimetableName = ({ timetable }) => {
  return (
    <div className="flex items-center justify-center text-xl font-bold text-soft-text px-5 py-3 bg-white border border-border rounded-xl shadow-lg mb-5 md:text-2xl">
      <span>
